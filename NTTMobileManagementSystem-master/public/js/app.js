...
$(function () {
    ...
    if (o.enableBSToppltip) {
        $('body').tooltip({selector: o.BSTooltipSelector, container: 'body'})
    }
...
function _init() {
    ...
    $.AdminLTE.controlSidebar = {
        activate: function () {
            ...
            sidebar.css({'position': 'fixed', 'max-height': '100%', 'overflow': 'auto', 'padding-bottom': '50px'})
...
(function ($) {
    ...
    $.fn.boxRefresh = function (options) {
        var settings = $.extend({
            trigger: ".refresh-btn", source: "", onLoadStart: function (box) {
                return box
